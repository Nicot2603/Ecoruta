...
export default function RastreoTab() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ background: "white", borderRadius: 14, padding: "20px 22px", border: "1px solid #f0e8e2", display: "flex", alignItems: "center", gap: 12 }}>
        <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#6b1a2a" }} />
      ...
      <div style={{ background: "white", borderRadius: 14, padding: "28px", border: "1px solid #f0e8e2" }}>
        <div style={{ background: "#f9f6f1", borderRadius: 10, height: 120, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 28, border: "1px solid #f0e8e2" }}>
